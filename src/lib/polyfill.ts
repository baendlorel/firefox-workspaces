  ...
  const browserPolyfill = {
    ...
    tabs: {
      ...
      update: (tabId: number, updateProperties: chrome.tabs.UpdateProperties) =>
        promisify<chrome.tabs.Tab>(chromeApi.tabs.update, chromeApi.tabs)(tabId, updateProperties),
    ...
    windows: {
      ...
      getCurrent: promisify<chrome.windows.Window>(chromeApi.windows.getCurrent, chromeApi.windows),
    ...
    notifications: {
      ...
      clear: (notificationId: string): Promise<boolean> =>
        promisify<boolean>(chromeApi.notifications.clear, chromeApi.notifications)(notificationId),
    },
